package com.ecommerce.ecommerceApp.utils.constant;

/**
 * @author Divakar Verma
 * @created_at : 11/01/2024 - 4:06 pm
 * @mail_to: vermadivakar2022@gmail.com
 */
public class ApiMessage {
    public static final String BAD_CREDENTIALS = "Invalid Username or Password";
    public static final String REGISTRATION_SUCCESSFUL = "User Registered Succesfully";
