package com.ecommerce.ecommerceApp.config.swagger;
...
public class OpenApiConfig {
    ...
    private String devUrl = "http://localhost:8085";
    ...
    public OpenAPI myOpenAPI(){
        ...
        Info info = new Info()
                ...
                .version("1.0")
                .contact(contact)
                .description("This api exposes endpoint to manage ecommerce")
                .license(mitLicense);
        ...
        return new OpenAPI().addSecurityItem(securityRequirement)
                .components(components).info(info).servers(Arrays.asList(devServer,prodServer));
